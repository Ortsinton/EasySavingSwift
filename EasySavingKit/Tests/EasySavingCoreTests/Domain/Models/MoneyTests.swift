...
struct MoneyTests {
    ...
    @Test(arguments: [
        (amount: 1000, scalar: 250, mult: 250_000), // normal case
        (amount: 1000, scalar: 0, mult: 0), // multiply by zero
        (amount: -500, scalar: 500, mult: -250_000), // negative case
        (amount: -300, scalar: -700, mult: 210_000), // both negative, positive result
